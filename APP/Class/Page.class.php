...
class SubPages{
  ...
  function subPageCss2(){
   ...
   $subPageCss2Str="";
    ...
    $subPageCss2Str.="<ul class='pagination pagination-sm'><li><a href='$firstPageUrl'>首页</a></li>";

    $subPageCss2Str.="<li><a href='$prewPageUrl'>&laquo;</a></li>";

    }else {

    $subPageCss2Str.="<ul class='pagination pagination-sm'><li class='disabled'><a href='#'>首页</a></li>";
   ...
   $a=$this->construct_num_Page();
    ...
    $subPageCss2Str.="&nbsp;&nbsp;<ul  class='pagination pagination-sm'> <li><span class=disabled>当前".$this->current_page."/".$this->pageNums."页</span></li> </ul>";
